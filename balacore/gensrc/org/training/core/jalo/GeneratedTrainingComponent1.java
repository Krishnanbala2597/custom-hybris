...
/**
 * Generated class for type {@link org.training.core.jalo.TrainingComponent1 TrainingComponent1}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedTrainingComponent1 extends SimpleCMSComponent
{
	/** Qualifier of the <code>TrainingComponent1.productName</code> attribute **/
	public static final String PRODUCTNAME = "productName";
	/** Qualifier of the <code>TrainingComponent1.brand</code> attribute **/
	public static final String BRAND = "brand";
	/** Qualifier of the <code>TrainingComponent1.productImage</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>TrainingComponent1.brand</code> attribute.
	 * @return the brand
	 */
	public String getBrand(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedTrainingComponent1.getBrand requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>TrainingComponent1.brand</code> attribute. 
	...
	public void setBrand(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedTrainingComponent1.setBrand requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>TrainingComponent1.productImage</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>TrainingComponent1.productImage</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>TrainingComponent1.productName</code> attribute.
	...
	public String getProductName(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedTrainingComponent1.getProductName requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>TrainingComponent1.productName</code> attribute. 
	...
	public void setProductName(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedTrainingComponent1.setProductName requires a session language", 0 );
		}
